...
async function main() {
  ...
  for (const lang of ['en', 'sk'] as const) {
    ...
    await renderMedia({ composition: c2, serveUrl, timeoutInMilliseconds: 120000, codec: 'h264', outputLocation: p2, inputProps: s2Props });
    ...
    await renderStill({  composition: c3, serveUrl, timeoutInMilliseconds: 120000, output: p3, inputProps: s3Props });
    ...
    await renderStill({  composition: c4, serveUrl, timeoutInMilliseconds: 120000, output: p4, inputProps: s4Props });
