...
5. STUDENT: gives ONE short concrete example of how they would use it (max 12 words). Keep it simple and short. Examples: "So I could use this to merge two user lists, right?" or "Nice, so in my todo app this would prevent duplicates." ALWAYS a specific use case, NEVER restating what the teacher said.
