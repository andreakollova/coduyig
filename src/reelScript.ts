...
6. TEACHER: Acknowledge student's example briefly, then broaden it. Say "Yes, that's a simple version. But it goes much further." then give a bigger real-world example. Max 20 words. Example: "Yes, that's a simple version. But Spotify uses this same thing to manage millions of playlists." Show that the concept scales beyond the student's small example.
