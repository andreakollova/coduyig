...
5. STUDENT: shows they understood by giving their OWN CONCRETE EXAMPLE of how they would use it (max 20 words). NOT a summary. NOT repeating the teacher. The student imagines a real mini-scenario. Examples: "Oh cool, so if I have users from two databases I can merge them without duplicates." or "Nice, so in my todo app I could use this to avoid repeating tasks." ALWAYS a specific use case, NEVER restating what the teacher said.
