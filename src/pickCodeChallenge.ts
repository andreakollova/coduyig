...
const fillExercises = [
  { id: 'fill-var-1', prompt_sk: 'Doplň kód tak, aby premenná mesto obsahovala hodnotu "Bratislava":', prompt_en: 'Fill in the code so the variable city contains "Bratislava":', code: '___ = "Bratislava"', options: ['var', 'mesto', 'string', 'let'], correct: 'mesto', difficulty: 'beginner' },
  { id: 'fill-types-1', prompt_sk: 'Doplň správny typ pre každú premennú:', prompt_en: 'Fill in the correct type for each variable:', code: 'vek = 25           # ___', options: ['str', 'int', 'float', 'bool'], correct: 'int', difficulty: 'beginner' },
  { id: 'fill-str-1', prompt_sk: 'Doplň kód aby vypísal dĺžku reťazca:', prompt_en: 'Fill in the code to print the string length:', code: 'slovo = "Python"\nprint(___(slovo))', options: ['len', 'size', 'count', 'length'], correct: 'len', difficulty: 'beginner' },
  { id: 'fill-math-1', prompt_sk: 'Doplň operátor na výpočet zvyšku po delení:', prompt_en: 'Fill in the operator for remainder after division:', code: 'zvysok = 10 ___ 3\nprint(zvysok)  # 1', options: ['/', '//', '%', '**'], correct: '%', difficulty: 'beginner' },
  { id: 'fill-cmp-1', prompt_sk: 'Doplň operátor "nerovná sa":', prompt_en: 'Fill in the "not equal" operator:', code: 'print(10 ___ 5)  # True', options: ['!=', '!==', '<>', '=/='], correct: '!=', difficulty: 'beginner' },
  { id: 'fill-if-1', prompt_sk: 'Doplň chýbajúce kľúčové slová:', prompt_en: 'Fill in the missing keywords:', code: '___ teplota > 30:\n    print("Horúco")', options: ['if', 'when', 'check', 'for'], correct: 'if', difficulty: 'beginner' },
  { id: 'fill-elif-1', prompt_sk: 'Doplň správne kľúčové slovo:', prompt_en: 'Fill in the correct keyword:', code: 'if temp > 30:\n    print("Hot")\n___ temp > 20:\n    print("Warm")', options: ['elif', 'else if', 'elseif', 'or if'], correct: 'elif', difficulty: 'beginner' },
  { id: 'fill-for-1', prompt_sk: 'Doplň kód aby vypísal čísla 1 až 5:', prompt_en: 'Fill in the code to print numbers 1 to 5:', code: 'for i in ___(1, 6):\n    print(i)', options: ['range', 'list', 'loop', 'iter'], correct: 'range', difficulty: 'beginner' },
  { id: 'fill-async-1', prompt_sk: 'Doplň správne kľúčové slová:', prompt_en: 'Fill in the correct keywords:', code: '___ function loadUser() {\n  const data = ___ fetchUser();\n  return data;\n}', options: ['async', 'sync', 'parallel', 'defer'], correct: 'async', difficulty: 'advanced' },
  { id: 'fill-ts-1', prompt_sk: 'Doplň union type, ktorý môže byť string alebo null:', prompt_en: 'Fill in the union type that can be string or null:', code: 'type MaybeString = string ___ null;', options: ['|', '&', '?', '+'], correct: '|', difficulty: 'advanced' },
];
