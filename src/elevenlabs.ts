...
const SK_PHONETICS: Record<string, string> = {
  ...
  'RISC': 'risk',
  'JIT': 'džit',
  // === termFull words (ByteFall glossary) — SK pronunciation ===
  ...
  'Character': 'Kerektr',
  'character': 'kerektr',
  'Generative': 'Dženeretiv',
  'Pre-trained': 'Prí trejnd',
  'Transformer': 'Transformr',
  'Adaptation': 'Edeptejšn',
  'Parameter': 'Paramítr',
  'Efficient': 'Efišnt',
  'Fine-Tuning': 'Fajn Tjúning',
  'Continuous': 'Kontinjues',
  'continuous': 'kontinjues',
  'Integration': 'Integrejšn',
  'integration': 'integrejšn',
  'Manager': 'Menedžr',
  'manager': 'menedžr',
  'Interpreter': 'Interprtr',
  'interpreter': 'interprtr',
  'Universally': 'Juniverzli',
  'Unique': 'Juník',
  'unique': 'juník',
  'Separated': 'Seperéjtid',
  'Values': 'Veljús',
  'values': 'veljús',
