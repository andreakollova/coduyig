...
const glossary = [
  ...
  { id: 'git', term: 'Git', category: 'nastroj', short: 'Version Control System',
    explanation_sk: 'Systém na sledovanie zmien v kóde. Ako "save game" pre programátorov. Môžeš sa vrátiť k akejkoľvek verzii, pracovať v tíme bez toho aby si si navzájom prepisovali kód, a vidieť kto čo kedy zmenil.',
    explanation_en: 'A system for tracking code changes. Like "save game" for programmers. You can go back to any version, work in a team without overwriting each other, and see who changed what and when.',
  ...
  { id: 'dns', term: 'DNS', category: 'skratka', short: 'Domain Name System',
    explanation_sk: 'Telefónny zoznam internetu. Prekladá doménové mená (google.com) na IP adresy (142.250.80.46). Bez DNS by si musel písať čísla namiesto mien stránok.',
    explanation_en: 'The phone book of the internet. Translates domain names (google.com) into IP addresses (142.250.80.46). Without DNS you would have to type numbers instead of website names.',
