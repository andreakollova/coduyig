...
export const RemotionRoot: React.FC = () => (
  <>
    ...
    <Composition id="ByteSurf" component={ByteSurfAnimation} durationInFrames={30 * FPS} fps={FPS} width={REEL_W} height={REEL_H}
      ...
      defaultProps={{ equipment: {}, durationInFrames: 30 * FPS, question: 'What happens when you type google.com?', audioUrl: '', words: [], questionerStart: 0, questionerEnd: 0, theme: 'surf', surfColor1: '#f59e0b', surfColor2: '#fb923c' }} />
  </>
);
