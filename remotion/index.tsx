...
export const RemotionRoot: React.FC = () => (
  <>
    ...
    <Composition id="ByteFall" component={ByteFallAnimation} durationInFrames={12 * FPS} fps={FPS} width={REEL_W} height={REEL_H}
      defaultProps={{ equipment: {}, durationInFrames: 12 * FPS }} />
  </>
);
