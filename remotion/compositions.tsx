...
export const SlideCTA: React.FC<{
  ...
  return (
    <AbsoluteFill style={{ background: BG, fontFamily, display: 'flex', flexDirection: 'column', alignItems: 'center', padding: '56px 50px' }}>
      {/* App mockup */}
      <div style={{ flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
        <Img src={MOCKUP_SRC} style={{ height: 580, objectFit: 'contain', borderRadius: 32 }} />
      </div>

      {/* Title */}
      <h1 style={{
        fontSize: 52, fontWeight: 800, color: '#ffffff',
        textAlign: 'center', marginTop: 32, lineHeight: 1.1,
        letterSpacing: '-0.02em',
      }}>
        {lang === 'sk' ? 'Nájdi v Coduy app' : 'Find it in Coduy app'}
      </h1>

      <p style={{ fontSize: 26, color: '#aaa', marginTop: 12, textAlign: 'center' }}>
      ...
      {/* Divider */}
      <div style={{ width: '80%', height: 1, background: '#222', marginTop: 28 }} />

      {/* Save for later — bigger */}
      <div style={{
        marginTop: 24, display: 'flex', alignItems: 'center', gap: 16,
        padding: '22px 52px', borderRadius: 20,
        background: '#1a1a1a', border: '2px solid #333',
      }}>
        <svg width="30" height="34" viewBox="0 0 24 24" fill="none" stroke="#ffffff" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      ...
      {/* Handle — white */}
      <div style={{ position: 'absolute', bottom: 44, display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 8 }}>
        <CoduyLogo height={30} opacity={1} />
